...
def upgrade():
    ...
    op.create_foreign_key(
        None, "changeable_protected_characteristics", "gender", ["gender_id"], ["id"]
    )
...
def downgrade():
    ...
    op.add_column(
        "changeable_protected_characteristics",
        sa.Column("belief", sa.VARCHAR(length=128), autoincrement=False, nullable=True),
    )
    op.drop_constraint(
        "changeable_protected_characteristics_gender_id_fkey",
        "changeable_protected_characteristics",
        type_="foreignkey",
    )
    op.drop_constraint(
        "changeable_protected_characteristics_sexuality_id_fkey",
        "changeable_protected_characteristics",
        type_="foreignkey",
    )
