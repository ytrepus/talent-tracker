...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('socio_economic', sa.Column('income_earner_employee', sa.BOOLEAN(), autoincrement=False, nullable=True))
    op.add_column('changeable_protected_characteristics', sa.Column('gender', sa.VARCHAR(length=256), autoincrement=False, nullable=True))
    op.add_column('changeable_protected_characteristics', sa.Column('sexuality', sa.VARCHAR(length=128), autoincrement=False, nullable=True))
