...
class ReportFactory:
    ...
    def create_report(report_type: str, **kwargs) -> Report:
        ...
        characteristic_reports = {
            key: CharacteristicPromotionReport
            for key in [
                "ethnicity",
                "gender",
                "working_pattern",
        ...
        boolean_reports = {
            key: BooleanCharacteristicPromotionReport
            for key in ["long_term_health_condition", "caring_responsibility"]
        }
        offer_reports = {
            "delta": DeltaOfferPromotionReport,
            "meta": MetaOfferPromotionReport,
        }
        promotion_reports = {
            **characteristic_reports,
            **boolean_reports,
