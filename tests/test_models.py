...
class TestCandidate:
    def test_current_grade_returns_correct_grade(self, test_candidate, test_session, test_grades):
    ...
    def test_promoted_when_started(self, test_candidate, test_session, test_grades):
        grades = Grade.query.order_by(Grade.rank.asc()).all()
    ...
    def test_current_scheme_returns_current_scheme(self, test_candidate_applied_to_fls):
        assert test_candidate_applied_to_fls.current_scheme() == 'FLS'


class TestGrade:
    def test_eligible_returns_correct_grades(self, test_session, test_grades):
    ...
    def test_new_grades_returns_correct_grades(self, test_session, test_grades):
    ...
    def test_new_grades_returns_grades_in_rank_order(self, test_session, test_grades):
        current_grade = Grade(value='One below SCS', rank=5)
